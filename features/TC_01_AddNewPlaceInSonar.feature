...
Feature: Add a new place to Sonar
  ...
  @sanity
  Scenario Outline: Add a registered place from the provider's information
  ...
  Scenario Outline: Add a registered place from the provider's information for the second time
    Given provider name is <PROVIDER_NAME>
    And provider place id is <PROVIDER_PLACE_ID>
    When I send request using "PUT" method
